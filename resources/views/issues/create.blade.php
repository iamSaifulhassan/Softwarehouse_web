...
<body>
    ...
    <div class="main-container">
        <div class="page-header">
            ...
            <p style="color: rgba(255, 255, 255, 0.8);">Define project requirements and issues</p>
        </div>
            ...
            <a href="/dashboard/requirements-analyst" class="btn btn-back">← Back to Dashboard</a>
              <form method="POST" action="/issues/store">
                ...
                <div class="form-group">
                    ...
                    <textarea id="description" name="description" required placeholder="Provide detailed description of the requirement or issue"></textarea>
                </div>
